...
/**
  ...
  */
  ...
  Matriz_Dispersa sp; /**< Matriz dispersa que almacena la sopa de letras */
  VD <string> encontradas; /**< Vector que almacena las palabras encontradas */
  VD <string> ocultas; /**< Vector que almacena las palabras ocultas */
  string direccion; /**< Direccion en la que va la palabra */
  string titulo; /**< Titulo de la sopa de letras */
  Matriz_Dispersa acertadas; /**< Matriz con valores acertados */
